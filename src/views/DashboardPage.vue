            ...
            <div class="drawer lg:drawer-open md:opacity-100 opacity-0 md:relative absolute" id="drawerContent">
              ...
              <div class="drawer-side">
                ...
                <ul class="menu sticky sticky-top top-0 p-4 pt-8 space-y-3 bg-base-100 md:rounded-r-3xl rounded-none w-80 min-h-full text-base-content">
                  ...
                  <li>
                    <router-link class="text-base-content" @click="changePage('Home')" to="/dashboard">
                      <Icon class="text-2xl" icon="solar:home-2-linear" />
                      <span>Home</span>
                    </router-link>
                  </li>
                  <li>
                    <router-link class="text-base-content" @click="changePage('Profile')" to="/dashboard/profile">
                      <Icon class="text-2xl" icon="solar:user-linear" />
                      <span>Profile</span>
                    </router-link>
                  </li>
                  <li>
                    <router-link class="text-base-content" @click="changePage('Hand')" to="/dashboard/hand">
          ...
          <div class="xl:col-span-9 lg:col-span-8 col-span-12">
              ...
              <div class="w-full flex justify-between items-center md:ml-6 bg-base-100 p-6 rounded-bl-3xl">
                <div>
                  <h4 class="font-semibold text-base-content">
                    Welcome!
                    <div class="badge badge-primary" @click="changePage('Hand')">{{ data === null || data === undefined || data === "" ? 0 : Object.keys(data).length }}</div>
                  </h4>
                </div>
                <div>
                ...
                <div class="w-full p-6">
                  <div class="space-y-3 gap-6">
                    <div class="w-full bg-base-100 rounded-3xl">
                      <div class="p-6">
                        <h4>Hayago: Berawal Dari Antusiasme Terhadap Teknologi IoT dan AI</h4>
                        <p>
            ...
            <div v-if="page === 'Profile'">
              <div class="w-full flex justify-center items-center md:ml-6 bg-base-100 p-6 rounded-bl-3xl">
                <h4 class="font-semibold text-base-content">Profile</h4>
              </div>
              <div class="max-h-[88vh] overflow-y-auto">
                <div class="w-full p-6">
                  <div class="space-y-3 gap-6">
...
onMounted(() => {
  ...
  page.value = localStorage.getItem("page") || "Home";
...
function changePage(data: string) {
  page.value = data;
  localStorage.setItem("page", page.value);
  document.documentElement.setAttribute("data-page", page.value);
}
